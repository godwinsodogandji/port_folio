<template>
  ...
  const videos = ref([
    {
      title: "Vidéo 1",
      description: "Voici une longue description de la vidéo 1. Cette vidéo contient beaucoup d'informations intéressantes. Il y a des détails sur les techniques utilisées et beaucoup d'exemples à explorer dans cette vidéo.",
      src: "video1.mp4",
      showFullDescription: false,
    },
    {
      title: "Vidéo 2",
      description: "Une autre description un peu plus courte mais tout de même suffisamment détaillée pour donner une bonne idée de ce qu'on va trouver dans la vidéo. Ce sera instructif.",
      src: "video2.mp4",
      showFullDescription: false,
    },
    {
      title: "Vidéo 3",
      description: "Une courte vidéo d'introduction. Elle est rapide à regarder, mais elle fournit quelques informations essentielles.",
      src: "video3.mp4",
      showFullDescription: false,
    },
  ]);
