<template>
    <section class="bg-no-repeat bg-cover bg-center bg-[url('/src/assets/img/background.png')] min-h-screen">
        <div class="container mx-auto p-2">
            <h1 class="text-4xl text-center font-bold mb-20" >Details Projet</h1>
